...
export const MAP_MEDICAL_CENTER: GameMapConfig = {
  ...
  markers: [
    ...
    { id: 'stairs_up2', x: 54.92, y: 41.52, title: 'To Second Floor', type: 'stairs_up', layerId: 'ground', connections: ['stairs_down1'] },
    { id: 'stairs_up3', x: 62.18, y: 65.87, title: 'To First Floor', type: 'stairs_up', layerId: 'ground', connections: ['stairs_up_down1'] },
    { id: 'stairs_up4', x: 46.34, y: 46.97, title: 'To Second Floor', type: 'stairs_up', layerId: 'floor1', connections: ['stairs_down3'] },
    { id: 'stairs_up_down1', x: 56.05, y: 44.96, title: 'To Second Floor / To Ground Floor', type: 'stairs_up_down', layerId: 'floor1', connections: [{ targetId: 'stairs_down4', label: 'To Second Floor' }, { targetId: 'stairs_up3', label: 'To Ground floor' }] },
    { id: 'stairs_down1', x: 52.14, y: 45.93, title: 'To First Floor', type: 'stairs_down', layerId: 'floor2', connections: ['stairs_up2'] },
    ...
    { id: 'stairs_down4', x: 65.04, y: 75.88, title: 'To First Floor', type: 'stairs_down', layerId: 'floor2', connections: ['stairs_up_down1'] }
  ],
  objectives: [
