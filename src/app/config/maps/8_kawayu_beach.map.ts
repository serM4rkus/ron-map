...
const LAYERS: MapLayer[] = [
  { 
    id: 'floor2', 
    name: 'Second Floor', 
    imageUrl: './maps/8_kawayu_beach/kawayu_beach_floor2.webp',  
    zIndex: 1 
  },
  { 
    id: 'floor1', 
    name: 'First Floor', 
    imageUrl: './maps/8_kawayu_beach/kawayu_beach_floor1.webp',  
    zIndex: 2 
  },
  { 
    id: 'ground', 
    name: 'Ground Floor', 
    imageUrl: './maps/8_kawayu_beach/kawayu_beach_ground.webp',
    zIndex: 3, 
    isDefault: true 
  }
];
