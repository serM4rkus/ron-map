...
const LAYERS: MapLayer[] = [
  { 
    id: 'floor2', 
    name: 'Second Floor', 
    imageUrl: './maps/21_155_playa_vista_lane/155_playa_vista_lane_floor2.webp',  
    zIndex: 1 
  },
  { 
    id: 'floor1', 
    name: 'First Floor', 
    imageUrl: './maps/21_155_playa_vista_lane/155_playa_vista_lane_floor1.webp',  
    zIndex: 2 
  },
  { 
    id: 'ground', 
    name: 'Ground Floor', 
    imageUrl: './maps/21_155_playa_vista_lane/155_playa_vista_lane_ground.webp',
    zIndex: 3, 
    isDefault: true 
  }
];
...
const OBJECTIVE_MARKERS: GameMarker[] = [
  // Second Floor - Panic Room (Possible Location)
  { 
    id: 'hard_objective1', 
    x: 40, 
    y: 57.28, 
    title: 'Possible Active Panic Room', 
    description: 'Rescue the family, located inside the panic room', 
    type: 'hard_objective', 
    layerId: 'floor2' 
  },
  
  // First Floor - Panic Room (Possible Location) + Hostage
  { 
    id: 'hard_objective2', 
    x: 55.55, 
    y: 61.99, 
  ...
  { 
    ...
    x: 29.83, 
    y: 66.69, 
    title: 'Rescue Sven Anderson-Lincoln', 
    description: 'Rescue the owner of the house, Sven Anderson-Lincoln. Usually located in his office on the first floor.', 
    type: 'hard_objective', 
    layerId: 'floor1' 
  }
];
...
const OBJECTIVES: MapObjective[] = [
  ...
  { 
    id: 'obj1', 
    title: 'Rescue Family from Panic Room', 
    description: 'Rescue the family, located inside the panic room', 
    type: 'hard', 
    markerIds: ['hard_objective1', 'hard_objective2'], 
    floorName: 'First & Second Floor' 
  },
  { 
    id: 'obj2', 
    title: 'Rescue Sven Anderson-Lincoln', 
