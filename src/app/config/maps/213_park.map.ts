...
export const MAP_213_PARK: GameMapConfig = {
  ...
  markers: [
    ...
    { id: 'stairs_up1', x: 54.5, y: 38.31, title: 'To First Floor', type: 'stairs_up', layerId: 'ground', connections: ['stairs_down4'] },
    { id: 'stairs_up2', x: 51.13, y: 37.56, title: 'To First Floor', type: 'stairs_up', layerId: 'ground', connections: ['stairs_down3'] },
    { id: 'stairs_down1', x: 51.01, y: 18.66, title: 'To Undeground', type: 'stairs_down', layerId: 'ground', connections: ['stairs_up4'] },
    { id: 'stairs_down2', x: 44.16, y: 16.57, title: 'To Udeground', type: 'stairs_down', layerId: 'ground', connections: ['stairs_up5'] },
    { id: 'stairs_down3', x: 47.14, y: 52.58, title: 'To Ground Floor', type: 'stairs_down', layerId: 'floor1', connections: ['stairs_up2'] },
    { id: 'stairs_down4', x: 52.44, y: 54.15, title: 'To First Floor', type: 'stairs_down', layerId: 'floor1', connections: ['stairs_up1'] },
    { id: 'stairs_up3', x: 51.97, y: 48.54, title: 'To Second Floor', type: 'stairs_up', layerId: 'floor1', connections: ['stairs_down5'] },
    { id: 'stairs_down5', x: 39.33, y: 61.32, title: 'To First floor', type: 'stairs_down', layerId: 'floor2', connections: ['stairs_up3'] },
    { id: 'stairs_up4', x: 39.83, y: 33.33, title: 'To Ground Floor', type: 'stairs_up', layerId: 'underground', connections:['stairs_down1'] },
    { id: 'stairs_up5', x: 59.96, y: 65.65, title: 'To Ground Floor', type: 'stairs_up', layerId: 'underground', connections:['stairs_down2'] }
  ],
  objectives: [
