...
export const GAME_MAPS_METADATA: GameMapMetadata[] = [
  {
    ...
    order: 1,
    category: 'base',
    preview_picture: './maps/1_4U_gas/4U_Gas_Station_preview.webp',
  ...
  },
  {
    ...
    order: 2,
    category: 'base',
    preview_picture: './maps/2_23_mb/23_Megabytes_a_Second_preview.webp',
  ...
  },
  {
    ...
    order: 3,
    category: 'base',
    preview_picture: './maps/3_213_park/213_Park_preview.webp',
  ...
  },
  {
    ...
    order: 4,
    category: 'base',
    preview_picture: './maps/4_brixley_talent/brixley_talent_preview.webp',
  ...
  },
  {
    ...
    order: 5,
    category: 'base',
    preview_picture: './maps/5_sullivans_slope/Sullivans slope_preview.webp',
  ...
  },
  {
    ...
    order: 6,
    category: 'base',
    preview_picture: './maps/6_brisa_cove/brisa_cove_preview.webp',
  ...
  },
  {
    ...
    order: 7,
    category: 'base',
    preview_picture: './maps/7_mindjot/mindjot_preview.webp',
  ...
  },
  {
    ...
    order: 8,
    category: 'base',
    preview_picture: './maps/8_kawayu_beach/kawayu_beach_preview.webp',
  ...
  },
  {
    ...
    order: 9,
    category: 'base',
    preview_picture: './maps/9_los_suenos_postal/los_suenos_postal_preview.webp',
  ...
  },
  {
    ...
    order: 10,
    category: 'base',
    preview_picture: './maps/10_voll_health_house/voll_health_house_preview.webp',
  ...
  },
  {
    ...
    order: 11,
    category: 'base',
    preview_picture: './maps/11_watt_college/watt_college_previre.webp',
  ...
  },
  {
    ...
    order: 12,
    category: 'base',
    preview_picture: './maps/12_costa_vino/costa_vino_preview.webp',
  ...
  },
  {
    ...
    order: 13,
    category: 'base',
    preview_picture: './maps/13_clemente_hotel/clemente_hotel_preview.webp',
  ...
  },
  {
    ...
    order: 14,
    category: 'base',
    preview_picture: './maps/14_neon_nightclub/neon_nightclub_preview.webp',
  ...
  },
  {
    ...
    order: 15,
    category: 'base',
    preview_picture:'./maps/15_ceasars_cars_dealership/ceasars_cars_dealership_preview.webp',
  ...
  },
  {
    ...
    order: 16,
    category: 'base',
    preview_picture: './maps/16_cherryessa_farm/cherryessa_farm_preview.webp',
  ...
  },
  {
    ...
    order: 17,
    category: 'base',
    preview_picture: './maps/17_medical_center/medical_center_preview.webp',
  ...
  },
  {
    ...
    order: 18,
    category: 'base',
    preview_picture: './maps/18_port/port_preview.webp',
  ...
  // Home Invasion DLC.
  {
    ...
    preview_picture: './maps/19_greenside_dormitories/greenside_dormitories_preview.webp',
  ...
  },
  {
    ...
    order: 20,
    category: 'dlc-home-invasion',
    preview_picture: './maps/20_25_hope_street/25_hope_street_preview.webp',
  ...
  },
  {
    ...
    order: 21,
    category: 'dlc-home-invasion',
    preview_picture: './maps/21_155_playa_vista_lane/155_playa_vista_lane_preview.webp',
  ...
  // Dark Waters DLC.
  {
    ...
    preview_picture: './maps/22_Seraglio/Seraglio_preview.webp',
  ...
  },
  {
    ...
    order: 23,
    category: 'dlc-dark-waters',
    preview_picture: './maps/23_HeavyWell_Rig/HeavyWell_A-101_Rig_preview.webp',
  ...
  },
  {
    ...
    order: 24,
    category: 'dlc-dark-waters',
    preview_picture: './maps/24_elysian/elysian_preview.webp',
  ...
  // Los Suenos Stories.
    ...
    preview_picture: './maps/25_chicos_mexican_resturant/chicos_mexican_resturant_preview.webp',
  ...
  },
  {
    ...
    order: 26,
    category: 'los-suenos-stories',
    preview_picture: './maps/26_edgeware_apartments/edgeware_apartments_preview.webp',
  ...
  },
  {
    ...
    order: 28,
    category: 'boiling-point',
    preview_picture: './maps/28_bank/bank_preview.webp',
  ...
  },
  {
    ...
    order: 29,
    category: 'boiling-point',
    preview_picture: './maps/29_city_hall/city_hall_preview.webp',
